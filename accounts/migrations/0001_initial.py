    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.TextField(verbose_name='Глава')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_name', models.CharField(blank=True, max_length=60, verbose_name='middle_name')),
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='registered')),
                ('is_active', models.BooleanField(default=True, verbose_name='is_active')),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('is_superuser', models.BooleanField(default=False)),
                ('is_staff', models.BooleanField(default=False, verbose_name='staff status')),
                ('user_image', models.ImageField(default='/static/img/image.png', upload_to='staticfiles/img/profile')),
                ...
                ('rassilka', models.BooleanField(blank=True, default=True, null=True)),
